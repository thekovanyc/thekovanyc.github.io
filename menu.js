var data = {
  egg_dishes: [
    { name: "Mushroom & Onion Omelette", price: 10.25 },
    { name: "Spinach & Cheese Omelette", price: 10.25 },
    {
    ...
    },
    {
      ...
      extras: [
        ...
        { name: "Caramelized Onion", price: 1.0 },
  ...
  pancake_toast_salad: [
    ...
    },
    {
      ...
      extras: [
        ...
        { name: "Toast (Rye, White, Multigrain)", price: 1.75 },
  ...
  coffee: [
    ...
    { name: "Lavender Latte", price: 5.5 },
    { name: "The Kova Latte", price: 5.75 },
    { name: "Crème Brulee Latte", price: 5.5 },
  ...
  other_drinks: [
    ...
    { name: "Homemade Hibiscus Lemonade", price: 4.0 },
    { name: "Homemade Lavender Lemonade", price: 4.0 },
  ],
};
